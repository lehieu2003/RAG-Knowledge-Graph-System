...
const MODES = [
  { value: 'auto', label: 'Auto', description: 'Intelligent routing (recommended)' },
...
export default function ChatPage() {
  ...
  const [mode, setMode] = useState<'auto' | 'graph' | 'text' | 'hybrid'>('auto')
  ...
  return (
    <div className="max-w-5xl mx-auto h-[calc(100vh-8rem)] flex flex-col">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Chat with Knowledge Graph</h1>
        ...
        {messages.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 max-w-md mx-auto">
              Ask questions about your documents and I'll retrieve relevant information from the knowledge graph.
            </p>
          </div>
        )}
                    ...
                    <div className="mt-3 pt-3 border-t border-gray-200">
                      <div className="flex items-center gap-4 text-xs text-gray-600 mb-2">
                        <span className="font-medium">
                          Mode: <span className="text-primary-600">{message.response.mode_used}</span>
                        </span>
                        <span>
                          ...
                          {message.response.evidence.slice(0, 3).map((ev, i) => (
                            <div key={i} className="text-xs bg-white rounded p-2">
                              ...
                              <div className="text-gray-500">
                                Page {ev.page_start}-{ev.page_end} • Score: {(ev.score * 100).toFixed(0)}%
                              </div>
                            </div>
                          ))}
                        </div>
